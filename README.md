...
This theme hard codes a number of things specific to my website, so it isn't really meant to be used on other websites.
...
Copyright (c) 2024 Jonah Aragon - Released under the [MIT license](LICENSE).
